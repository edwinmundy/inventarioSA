...
function inicializarDatos() {
    ...
    // Inicializar cajeros explícitamente
    const cajerosKey = STORAGE_KEYS.cajeros;
    const cajerosExistentes = localStorage.getItem(cajerosKey);
    
    if (!cajerosExistentes || JSON.parse(cajerosExistentes).length === 0) {
        console.log('Inicializando cajeros por defecto...');
...
function asegurarAdminExiste() {
    ...
    // Si no hay array de cajeros, crearlo
